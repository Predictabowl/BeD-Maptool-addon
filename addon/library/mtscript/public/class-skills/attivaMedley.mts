...
[macro("class-skills/getRandomEffettoSonata@this"): json.append(source)] <!-- Questo non esiste ancora -->
...
[h, macro("class-skills/getDurataAbilita@this"): json.append(oToken, sLibName)]
[h: iDurata = macro.return]
[macro("class-skills/createEffettoSonata@this"): json.append(aMotivoScelto,"ALLEATI")]
