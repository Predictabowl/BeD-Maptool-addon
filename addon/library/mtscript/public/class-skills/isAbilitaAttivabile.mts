...
[macro("class-skills/getAbilitaClasseTutte@this"): source]
[h, if(!json.contains(macro.return, sLibAbilita)): return(0,0)]

[h, macro("class-skills/getTipoAbilita@this"): sLibAbilita]
...
[macro("class-skills/getAbilitaClasse@this"): json.append(source,"Lib:NessunaPieta")]
[h: noMercy = macro.return]

[macro("class-skills/getBloccoAbilita@this"):json.append(source,sLibAbilita)]
...
[macro("class-skills/getAbilitaInUso@this"): json.append(source,sTipo)]
