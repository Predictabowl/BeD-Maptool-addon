...
[macro("core/popStatModifier@this"): json.append(target,"rerollSchivare")]
...
[h: iSchivare = getSchivare(target)]
[h: iAccuratezza = getAccuratezza(source)]

[h: iMod = getSchivareProb(iSchivare-iAccuratezza)*1000]
...
[h, if(getOverride(target, "failSchivare") > 0): result = 0]
...
[h, if(result<1000), code:{
	...
	[result = 1]
	[macro("events/runEvents@this"): json.set("","event","On_Dodge","source",target,"target",source)]
}]
