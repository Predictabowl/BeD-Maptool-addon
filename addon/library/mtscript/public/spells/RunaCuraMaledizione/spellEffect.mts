...
[h: spellName = "RunaCuraMaledizione"]
...
[macro("core/retrieveEffect@lib:it.aldinucci.piero.bed.maptool.ruleset"): json.append(target,"categoria","Maledizione")]
[h: lEffects = json.toList(macro.return)]
[h, if(listCount(lEffects)>0): bFlag = 1; bFlag = 0]

[h, if(bFlag), code:{
	[h: bCheck = input(strformat("sEffect|%{lEffects}|Maledizione da rimuovere|RADIO|value = string"))]
