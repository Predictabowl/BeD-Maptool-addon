...
[h: temp = json.set("","macroName","spells/Sfidare/attivazioneRemove@lib:it.aldinucci.piero.bed.maptool.ruleset","tipo","macroCall")]
...
[eventParam = json.set("","name",spellName,"event","on_Opportunita","token",source,"macroName","spells/Sfidare/eventMarchio@lib:it.aldinucci.piero.bed.maptool.ruleset", "macroParam", jMacroParam)]
