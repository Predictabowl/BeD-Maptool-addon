...
[r, if(iLL > 0), code:{
	...
	[macro("spells/MorsoViverna/getPoisonStack@lib:it.aldinucci.piero.bed.maptool.ruleset"):json.set("","target",target)]
	...
	[h: temp = json.set("","tipo","macroCall","macroName","spells/MorsoViverna/specialEffect@lib:it.aldinucci.piero.bed.maptool.ruleset","parametri",macroParam)]
