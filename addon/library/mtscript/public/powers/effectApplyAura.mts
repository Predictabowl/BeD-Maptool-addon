...
updateMacro - Macro da chiamare all'inizio di ogni round
...
[h: effectBasicAuraRemove = json.set("","source",source,"idAura",idAura,"tipo","aura")]
...
[h, if(otherAuraParams != ""), code:{
	[h: effectARParamList = json.append(effectARParamList,otherAuraParams)]
}]
...
[h: param = json.set("","source",source,"caster",caster,"idAura",idAura,"tipoMov",sTipoMov,"nomeMacro",sNomeMacro,"macroParam",oMacroParam,
	"AOE",iAOE,"portata",iRange,"FOF",sFOF,"visualizza",iVisualAura,"isTransitable", bTransitable)]
[macro("powers/setupAura@this"):param]
[h: tOrigine = json.get(macro.return, "origine")]
