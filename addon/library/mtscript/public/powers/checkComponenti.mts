...
[h, if(listContains(listComponenti,"M") && bCheck), code:{
	[macro(buildSpellMacroName(spellName,"componenteMateriale")): json.set("","source",source)]
	[bCheck = macro.return]
	[if(!bCheck), code:{
...
[h, if(listContains(listComponenti,"F") && bCheck), code:{
	[macro(buildSpellMacroName(spellName,"componenteFocus")): json.set("","source",source)]
	[bCheck = macro.return]
	[if(!bCheck), code:{
