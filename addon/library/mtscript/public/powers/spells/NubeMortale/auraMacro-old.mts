...
[h: jDotParams = json.set("","danno","1d3","LL",iLL,"LP",iLP,"spellLib",spellName,"lanciatore",source,"critRes", bCrit,"potenzaCritico",getPCrit(source),"percMod",fPercMod)]
...
[h: oEffetto = json.set("","subito",0,"params",altro,"verbose",0, "effetto", sNomeEffAux, "stato", "Veleno")]
[h: oSpellEffectParam = json.set("","source",source,"target",target,"spellName",spellName,"effetto",oEffetto, "LL", iLL, "CD", iCD, "durata", 3)]
