...
[h: temp = json.set("","macroName","powers/spells/Sfidare/attivazioneRemove@lib:it.aldinucci.piero.bed.maptool.ruleset","tipo","macroCall")]
...
[eventParam = json.set("","name",spellName,"event","on_Opportunita","token",source,"macroName","powers/spells/Sfidare/eventMarchio@lib:it.aldinucci.piero.bed.maptool.ruleset", "macroParam", jMacroParam)]
