...
[h: spellName = "RafficaLetale"]
[h: sName = fetchSpellProp(spellName,"nome_decorativo")]

<!-- Effetto di rimozione -->
[h: oParamEffetto = json.set("","source",source,"tipo","macroCall","macroName","powers/spells/RafficaLetale/removeEffect@lib:it.aldinucci.piero.bed.maptool.ruleset")]
...
[h: addDannoArmaAgg(source,spellName,"4d3","mischia")]
