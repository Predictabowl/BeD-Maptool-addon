...
[h, if(bAfflitto == 0), code:{
	...
	[h: temp = json.set("","macroName","powers/spells/StraledellaRovina/removeEvent@lib:it.aldinucci.piero.bed.maptool.ruleset","tipo","macroCall")]
	...
	[macro("events/eventInstaller@lib:it.aldinucci.piero.bed.maptool.ruleset"): json.set("","token",source,"event","On_Spellcast","name",spellName,"macroName","powers/spells/StraledellaRovina/oneShot@lib:it.aldinucci.piero.bed.maptool.ruleset")]
