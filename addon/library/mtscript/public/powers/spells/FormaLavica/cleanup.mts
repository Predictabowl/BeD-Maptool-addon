...
[h, if(remove == 1), code:{
	...
	[macro("powers/delSpellMod@lib:it.aldinucci.piero.bed.maptool.ruleset"):json.append(target, "powers/spells/FormaLavica/costModChecker@lib:it.aldinucci.piero.bed.maptool.ruleset", "PP")] 
