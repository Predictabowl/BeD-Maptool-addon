...
[macro("powers/getSpellDamage@lib:it.aldinucci.piero.bed.maptool.ruleset"): json.set("","LP",iLP,"dmgLP",sDmg,"target",target,"source",source,"spell",spellName)]
[h: iDanno = macro.return]

[h: oEffetto = json.set("","target",target,"effetto",nomeEffetto,"subito",1,"tipo","Magia","verbose",0)]
[h: macroParam = json.set("","danno",iDanno,"source",source,"durata",iDurata,"effettoAux",nomeEffAux)]
[h: temp = json.set("","tipo","macroCall","macroName","powers/spells/CommozioneCelebrale/specialEffect@lib:it.aldinucci.piero.bed.maptool.ruleset","parametri",macroParam)]
