...
[h: setProperty("Danno_Arma1","4d6",source)]
...
[h: setProperty("Danno_Arma1",danno_save,source)]
...
[r, if(iLL > 0), code:{
	...
	[macro("powers/spells/CodaViverna/getPoisonStack@lib:it.aldinucci.piero.bed.maptool.ruleset"):json.set("","target",target)]
	[h: poisonStack = macro.return]


	[macro("powers/getDurata@lib:it.aldinucci.piero.bed.maptool.ruleset"): json.set("","source",source,"target",target,"spellName","CodaViverna")]
	...
	[h: tipo = fetchSpellProp("CodaViverna","tipo")]
	...
	[h: temp = json.set("","tipo","macroCall","macroName","powers/spells/CodaViverna/specialEffect@lib:it.aldinucci.piero.bed.maptool.ruleset","parametri",macroParam)]
	...
	[h: paralisi_e = json.set("","target",target,"LP",iLP,"TSRes",TSRes,"effect","Paralisi","durata",3,"spellName","Paralisi ("+fetchSpellProp(spellName,"nome_decorativo")+")")]
	[macro("powers/ifTSEffect@lib:it.aldinucci.piero.bed.maptool.ruleset"):paralisi_e]
