...
[h: jSecondParams = json.set("", "source", source, "target", lTokens, "spellName", spellName, "spellMacro", "powers/spells/EruzioneVitale/spellEffectHeal@lib:it.aldinucci.piero.bed.maptool.ruleset", "isAttack", 0)]
