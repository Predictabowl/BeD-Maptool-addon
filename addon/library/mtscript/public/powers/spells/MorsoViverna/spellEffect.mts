...
[r, if(iLL > 0), code:{
	...
	[macro("powers/spells/MorsoViverna/getPoisonStack@lib:it.aldinucci.piero.bed.maptool.ruleset"):json.set("","target",target)]
	...
	[h: temp = json.set("","tipo","macroCall","macroName","powers/spells/MorsoViverna/specialEffect@lib:it.aldinucci.piero.bed.maptool.ruleset","parametri",macroParam)]
