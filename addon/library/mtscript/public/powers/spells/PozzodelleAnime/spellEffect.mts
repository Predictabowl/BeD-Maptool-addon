...
[h: sMacroAtt = "powers/spells/PozzodelleAnime/attivaEffettoPozzo@lib:it.aldinucci.piero.bed.maptool.ruleset"]
[h: numCariche = 5]
...
[h: temp = json.set("","tipo","macroCall","macroName","powers/spells/PozzodelleAnime/effectRemove@lib:it.aldinucci.piero.bed.maptool.ruleset","parametri",macroParam)]
