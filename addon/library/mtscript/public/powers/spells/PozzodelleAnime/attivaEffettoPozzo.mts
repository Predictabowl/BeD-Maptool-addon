...
[h, if(iDistance <= iRange), code:{
	...
	[h: param = json.set("","target",source,"source",source,"macro","powers/spells/PozzodelleAnime/effettoCura@lib:it.aldinucci.piero.bed.maptool.ruleset","macroParam",oParametri,"tipo","Interazione","opp",0,"time",time,"action","Attiva "+nomeDec)]
