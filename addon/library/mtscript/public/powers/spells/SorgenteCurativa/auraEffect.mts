...
[h, if(remove != 1), code:{
	...
	[if(listContains(berColpiti,target) == 0), code:{
		...
		[macro("events/eventInstaller@lib:it.aldinucci.piero.bed.maptool.ruleset"):json.set("","name",spellName,"macroName","powers/spells/SorgenteCurativa/eventAura@lib:it.aldinucci.piero.bed.maptool.ruleset","macroParam",oMacroParam,"event","On_Damaged","token",target)]
	}]
