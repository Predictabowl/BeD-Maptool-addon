...
[h: temp = json.set("","macroName","powers/spells/Invisibilita/removeEvent@lib:it.aldinucci.piero.bed.maptool.ruleset","tipo","macroCall")]
...
[macro("events/eventInstaller@lib:it.aldinucci.piero.bed.maptool.ruleset"):json.set("","name",spellName,"macroName","powers/spells/Invisibilita/eventBreak@lib:it.aldinucci.piero.bed.maptool.ruleset","macroParam",oMacroParam,"event","On_Attack","token",source)]

<!-- Richiede un evento On_Attacked che aumenta il mancare del bersaglio a meno che non sia un attacco ad area (macro isAOE)-->

[macro("events/eventInstaller@lib:it.aldinucci.piero.bed.maptool.ruleset"): json.set("","token",source,"event","On_Attacked","name",spellName,"macroName","powers/spells/Invisibilita/eventMancareAttack@lib:it.aldinucci.piero.bed.maptool.ruleset")]
[macro("events/eventInstaller@lib:it.aldinucci.piero.bed.maptool.ruleset"): json.set("","token",source,"event","On_SpellCasted","name",spellName,"macroName","powers/spells/Invisibilita/eventMancareSpell@lib:it.aldinucci.piero.bed.maptool.ruleset")]
