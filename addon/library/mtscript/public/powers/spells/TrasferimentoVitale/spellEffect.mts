...
[h: spellName = "TrasferimentoVitale"]
...
[r, if(iLL > 0), code:{
	[h: difesa = 0]
	[h: param = json.set("","LP",iLP,"dmgLP","5","difesa",difesa,"elemento",elemento)]
	...
	[h: param = json.append("",source,danno)]
	...
	[h: cura = 5*iLL]
	[macro("core/CuraTarget@lib:it.aldinucci.piero.bed.maptool.ruleset"):json.append("",target,cura)]
};{}]
