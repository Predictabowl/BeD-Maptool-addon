...
[r, if(iLL > 0), code:{
	...
	[macro("powers/getDurata@lib:it.aldinucci.piero.bed.maptool.ruleset"): json.set("","source",source,"target",id,"spellName","MalattiaEmorragia")]
	[h: durata = macro.return]

	[h: param = json.set("","target",id)]
	[h: param = json.set(param,"durata",durata)]
	[h: param = json.set(param,"effetto","Malattia_Emorragia")]
	[h: param = json.set(param,"subito",1)]
	[h: param = json.set(param,"stato","Malato")]
	[h: param = json.set(param,"potenza",iLL)]
	[h: tipo = fetchSpellProp("MalattiaEmorragia","tipo")]
	...
	[h: temp = json.set("","tipo","macroCall","macroName","powers/spells/MalattiaEmorragia/specialEffect@lib:it.aldinucci.piero.bed.maptool.ruleset","parametri",macroParam)]
