...
[h: jArg = json.set("","source",source,"spell",spellName,"categoria","MAGIA", "eventoMacro", "powers/spells/MuroDiGhiaccio/specialEffect@lib:it.aldinucci.piero.bed.maptool.ruleset", "inizioRound", 1, "copertura", 100, "hasMBL", 1,"triggerRange",1)]
