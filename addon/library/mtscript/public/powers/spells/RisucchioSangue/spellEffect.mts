...
[h, if(flag == 0), code:{
	...
	[macro("powers/spells/RisucchioSangue/getMultiplier@lib:it.aldinucci.piero.bed.maptool.ruleset"):id]
	[h: moltiplicatore = macro.return]

	[h: param2 = json.set("","moltiplicatore",moltiplicatore)]
	[h: temp = json.set("","tipo","macroCall","macroName","powers/spells/RisucchioSangue/specialEffect@lib:it.aldinucci.piero.bed.maptool.ruleset","parametri",param2)]
