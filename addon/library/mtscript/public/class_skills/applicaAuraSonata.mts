...
[macro("class_skills/getEffettoSonata@this"): json.append(sOrigine,iMolt)]
[h: aMotivoScelto = macro.return]
[h, if(json.isEmpty(aMotivoScelto)): return(0,0)]
[macro("class_skills/createEffettoSonata@this"): json.append(macro.return,sTipoBersaglio)]
